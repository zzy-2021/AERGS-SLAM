...
public:
    ...
    MapRefiner(MapRefinementConfigs &configs, ros::NodeHandle nh,  MapPtr map, std::string& voc_path);
    ...
    void SaveAllFrameTrajectory(std::string save_path);
    ...
    void StartRefining(std::string& map_root);
...
typedef std::shared_ptr<MapRefiner> MapRefinerPtr;

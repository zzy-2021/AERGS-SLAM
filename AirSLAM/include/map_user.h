...
public:
    ...
    bool Relocalization(cv::Mat &image, Eigen::Matrix4d &pose, std::vector<FramePtr>& ref_frames, std::vector<int>& ref_frameIds);
    ...
    std::map<int, FramePtr> Getkeyframes();

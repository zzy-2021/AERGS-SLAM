...
SuperPoint::SuperPoint(const SuperPointConfig &super_point_config) : resized_width(512),
                                                                     resized_height(512),
                                                                     super_point_config_(super_point_config),
                                                                     engine_(nullptr) {
...
void SuperPoint::extract_descriptors(const float *descriptors, Eigen::Matrix<float, 259, Eigen::Dynamic> &features,
                                     int h, int w, int s) {
...
bool SuperPoint::keypoints_decoder(const float *scores, const float *descriptors,

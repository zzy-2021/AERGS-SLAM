...
bool SuperGlue::build() {
    ...
    profile->setDimensions(superglue_config_.input_tensor_names[0].c_str(), nvinfer1::OptProfileSelector::kMIN,
                           nvinfer1::Dims3(1, 1, 2));
    profile->setDimensions(superglue_config_.input_tensor_names[0].c_str(), nvinfer1::OptProfileSelector::kOPT,
    ...
    profile->setDimensions(superglue_config_.input_tensor_names[1].c_str(), nvinfer1::OptProfileSelector::kMIN,
                           nvinfer1::Dims2(1, 1));
    profile->setDimensions(superglue_config_.input_tensor_names[1].c_str(), nvinfer1::OptProfileSelector::kOPT,
                           nvinfer1::Dims2(1, 512));
    profile->setDimensions(superglue_config_.input_tensor_names[1].c_str(), nvinfer1::OptProfileSelector::kMAX,
                           nvinfer1::Dims2(1, 1024));
    profile->setDimensions(superglue_config_.input_tensor_names[2].c_str(), nvinfer1::OptProfileSelector::kMIN,
    ...
    profile->setDimensions(superglue_config_.input_tensor_names[3].c_str(), nvinfer1::OptProfileSelector::kMIN,
                           nvinfer1::Dims3(1, 1, 2));
    profile->setDimensions(superglue_config_.input_tensor_names[3].c_str(), nvinfer1::OptProfileSelector::kOPT,
                           nvinfer1::Dims3(1, 512, 2));
    profile->setDimensions(superglue_config_.input_tensor_names[3].c_str(), nvinfer1::OptProfileSelector::kMAX,
                           nvinfer1::Dims3(1, 1024, 2));
    profile->setDimensions(superglue_config_.input_tensor_names[4].c_str(), nvinfer1::OptProfileSelector::kMIN,
                           nvinfer1::Dims2(1, 1));
    profile->setDimensions(superglue_config_.input_tensor_names[4].c_str(), nvinfer1::OptProfileSelector::kOPT,
                           nvinfer1::Dims2(1, 512));
    profile->setDimensions(superglue_config_.input_tensor_names[4].c_str(), nvinfer1::OptProfileSelector::kMAX,
                           nvinfer1::Dims2(1, 1024));
    profile->setDimensions(superglue_config_.input_tensor_names[5].c_str(), nvinfer1::OptProfileSelector::kMIN,
                           nvinfer1::Dims3(1, 256, 1));
...
bool SuperGlue::process_input(const BufferManager &buffers,
    ...
    auto *descriptors_0_buffer = static_cast<float *>(buffers.getHostBuffer(
            superglue_config_.input_tensor_names[2]));
    ...
    auto *descriptors_1_buffer = static_cast<float *>(buffers.getHostBuffer(
            superglue_config_.input_tensor_names[5]));
